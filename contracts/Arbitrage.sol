...
contract Arbitrage is FlashLoanSimpleReceiverBase {
    ...
    function executeOperation(
        ...
        // Arbirtage operation
        dexContract.depositUSDC(1000000000); // 1000 USDC from the flash loan is deposited to the dex contract
        dexContract.buyDAI(); // this is used to buy DAI token
        dexContract.depositDAI(dai.balanceOf(address(this))); // deposit the DAI in the dex contract
        dexContract.sellDAI(); // sell the dai token and get usdc in exchange with profited amount
